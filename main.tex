...
\usepackage{mdframed} % For customizing boxes (just information for each section, remove later)
\usepackage{todonotes} % For adding notes (just for grading criteria, remove later)
% ============================= TO BE REMOVED WHEN FINISHED ============================
...
\addcontentsline{toc}{chapter}{Foreword} % Add to Table of
\input{sections/foreword.tex} % Input the content of the foreword
